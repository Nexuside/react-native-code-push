...
This plugin provides client-side integration for the [CodePush service](https://nexuside.com/), allowing you to easily add a dynamic update experience to your React Native app(s).
...
If you run into any issues, or have any questions/comments/feedback, [e-mail us](mailto:support@nexuside.com) and/or check out the [troubleshooting](#debugging--troubleshooting) details below.
...
Additionally, if you'd like more integrations, please message us at [support@nexuside.com](mailto:support@nexuside.com)
